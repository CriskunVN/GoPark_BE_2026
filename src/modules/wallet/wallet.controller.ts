...
export class WalletController {
  ...
  async deposit(
    ...
    const userId = dto.userId || req.user?.id || '123e4567-e89b-12d3-a456-426614174000';
  ...
  async payment(
    ...
    const customerId = dto.customerId || req.user?.id || '123e4567-e89b-12d3-a456-426614174000';
  ...
  async getMyTransactions(@Req() req: any) {
    const userId = req.query.userId || req.user?.id || '123e4567-e89b-12d3-a456-426614174000'; 
